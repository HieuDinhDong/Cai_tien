package com.example.shippinguserapplication.apis;
...
public interface ApiService {
    ...
    Call<UserResponse> loginDriver(@Query("phone") String phone,
                                   @Query("password") String password);


    @GET("/api/service/user_detail/{id}")
    Call<UserResponse> getUserDetail(@Path("id") int id);

    @GET("/api/service/driver_detail/{id}")
    Call<UserResponse> getDriverDetail(@Path("id") int id);

    @PUT("/api/service/update_user/{id}")
    ...
    Call<UserResponse> updateDriver(@Path("id") int id);
