...
import com.example.shippingdriverapplication.databinding.FragmentStaticMonthBinding;
...
public class StaticMonthFragment extends Fragment {

    FragmentStaticMonthBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentStaticMonthBinding.inflate(inflater, container, false);
    ...
    private void clickCallApiGetListOrder() {
        ApiService.apiService.staticOrderMonth(IdUser, getDayNow()).enqueue(new Callback<ListOrderResponse>() {
